...
void VIDU___024root__trace_chg_0_sub_0(VIDU___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VIDU___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIDU___024root__trace_chg_0\n"); );
    // Body
    ...
    VIDU___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void VIDU___024root__trace_chg_0_sub_0(VIDU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIDU___024root__trace_chg_0_sub_0\n"); );
    VIDU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgBit(oldp+0,(vlSelfRef.top__DOT__my_IDU__DOT__is_jalr_ok));
        bufp->chgBit(oldp+1,(vlSelfRef.top__DOT__my_IDU__DOT__is_add_ok));
        bufp->chgBit(oldp+2,(vlSelfRef.top__DOT__my_IDU__DOT__is_lw));
        bufp->chgBit(oldp+3,(vlSelfRef.top__DOT__my_IDU__DOT__is_sw));
        bufp->chgBit(oldp+4,(vlSelfRef.top__DOT__my_IDU__DOT__is_sb));
        bufp->chgBit(oldp+5,(vlSelfRef.top__DOT__is_memtoreg));
        bufp->chgBit(oldp+6,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sb) 
    ...
    bufp->chgIData(oldp+126,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_lw)
                               ? vlSelfRef.top__DOT__pmemdata
                               : ((2U & vlSelfRef.top__DOT__ALU_result)
                                   ? ((1U & vlSelfRef.top__DOT__ALU_result)
                                       ? (0x000000ffU 
    ...
    bufp->chgCData(oldp+127,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sw)
    ...
    bufp->chgIData(oldp+128,(((0x37U == (0x0000007fU 
                               ...
                               ? 0U : ((0U == (0x0000001fU 
                                       ...
                                       [(0x0000001fU 
                                         & (vlSelfRef.inst 
                                            >> 0x0000000fU))]))),32);
    bufp->chgIData(oldp+129,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_add_ok)
                               ? ((0U == (0x0000001fU 
                                          & (vlSelfRef.inst 
                                             >> 0x00000014U)))
                                   ? 0U : vlSelfRef.top__DOT__my_WBU__DOT__GPR__DOT__rf
                               ...
                               : (((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sb) 
                                   ...
                                   : ((0x37U == (0x0000007fU 
                                       ...
                                       : (((- (IData)(
                                          ...
                                          | (vlSelfRef.inst 
                                             >> 0x00000014U)))))),32);
    bufp->chgIData(oldp+130,((((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sb) 
                               | (IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sw))
                               ? (((- (IData)((vlSelfRef.inst 
                                               >> 0x0000001fU))) 
                                   << 0x0000000cU) 
...
void VIDU___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIDU___024root__trace_cleanup\n"); );
    // Body
    VIDU___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VIDU___024root*>(voidSelf);
    VIDU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
