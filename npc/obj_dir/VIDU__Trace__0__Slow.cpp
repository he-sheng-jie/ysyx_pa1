...
VL_ATTR_COLD void VIDU___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void VIDU___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void VIDU___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void VIDU___024root__trace_register(VIDU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&VIDU___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&VIDU___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&VIDU___024root__trace_chg_0, 0, vlSelf);
    tracep->addCleanupCb(&VIDU___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void VIDU___024root__trace_const_0_sub_0(VIDU___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void VIDU___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIDU___024root__trace_const_0\n"); );
    // Body
    VIDU___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VIDU___024root*>(voidSelf);
    VIDU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VIDU___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void VIDU___024root__trace_const_0_sub_0(VIDU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIDU___024root__trace_const_0_sub_0\n"); );
    VIDU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VIDU___024root__trace_full_0_sub_0(VIDU___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void VIDU___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIDU___024root__trace_full_0\n"); );
    // Body
    VIDU___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VIDU___024root*>(voidSelf);
    VIDU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VIDU___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void VIDU___024root__trace_full_0_sub_0(VIDU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIDU___024root__trace_full_0_sub_0\n"); );
    VIDU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    bufp->fullBit(oldp+1,(vlSelfRef.top__DOT__my_IDU__DOT__is_jalr_ok));
    bufp->fullBit(oldp+2,(vlSelfRef.top__DOT__my_IDU__DOT__is_add_ok));
    bufp->fullBit(oldp+3,(vlSelfRef.top__DOT__my_IDU__DOT__is_lw));
    bufp->fullBit(oldp+4,(vlSelfRef.top__DOT__my_IDU__DOT__is_sw));
    bufp->fullBit(oldp+5,(vlSelfRef.top__DOT__my_IDU__DOT__is_sb));
    bufp->fullBit(oldp+6,(vlSelfRef.top__DOT__is_memtoreg));
    bufp->fullBit(oldp+7,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sb) 
    ...
    bufp->fullIData(oldp+127,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_lw)
                                ? vlSelfRef.top__DOT__pmemdata
                                : ((2U & vlSelfRef.top__DOT__ALU_result)
                                    ? ((1U & vlSelfRef.top__DOT__ALU_result)
                                        ? (0x000000ffU 
    ...
    bufp->fullCData(oldp+128,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sw)
                                ? 0xffU : ((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sb)
                                            ? ((2U 
    ...
    bufp->fullIData(oldp+129,(((0x37U == (0x0000007fU 
                                ...
                                ? 0U : ((0U == (0x0000001fU 
                                        ...
                                        [(0x0000001fU 
                                          & (vlSelfRef.inst 
                                             >> 0x0000000fU))]))),32);
    bufp->fullIData(oldp+130,(((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_add_ok)
                                ? ((0U == (0x0000001fU 
                                           & (vlSelfRef.inst 
                                              >> 0x00000014U)))
                                    ? 0U : vlSelfRef.top__DOT__my_WBU__DOT__GPR__DOT__rf
                                ...
                                : (((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sb) 
                                    ...
                                    : ((0x37U == (0x0000007fU 
                                        ...
                                        : (((- (IData)(
                                           ...
                                           | (vlSelfRef.inst 
                                              >> 0x00000014U)))))),32);
    bufp->fullIData(oldp+131,((((IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sb) 
                                | (IData)(vlSelfRef.top__DOT__my_IDU__DOT__is_sw))
