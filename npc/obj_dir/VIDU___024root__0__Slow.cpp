...
VL_ATTR_COLD void VIDU___024root___ctor_var_reset(VIDU___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->top__DOT____Vcellout__my_WBU__debug_rf[__Vi0] = 0;
    }
    vlSelf->top__DOT__pmemdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 521010827019114059ull);
    vlSelf->top__DOT__my_IDU__DOT__is_add_ok = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 889475936367318829ull);
    vlSelf->top__DOT__my_IDU__DOT__is_jalr_ok = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6631648765563698987ull);
    vlSelf->top__DOT__my_IDU__DOT__is_lw = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10934801967356870219ull);
    vlSelf->top__DOT__my_IDU__DOT__is_sw = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14089141026537369604ull);
    vlSelf->top__DOT__my_IDU__DOT__is_sb = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8824848554245392803ull);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
